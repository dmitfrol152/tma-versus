...
export function NewSlideWelcome({
  currentStep,
  onNextStep,
  onPrevStep,
  onSkipSteps,
  ...
  return (
    <NewSlideLayout
      ...
      slideTitle={
        <NewSlideTitleBlock
          title="<WELCOME!"
          description="Versus between"
          target="— two teams>"
          classNameWidthContainer="welcome"
        />
      }
      slideDescription={
        <NewSlideDescriptionBlock
          description="To begin, select one of the
two teams to start competing and earning."
        />
      }
